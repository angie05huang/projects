...
class Ant(Insect):
    ...
    def add_to(self, place):
        if place.ant is None:
            ...
            if self.is_container == True and self.can_contain(place.ant) == True:
    ...
    def action(self, gamestate):
        if self.turns_to_chew > 0:
            ...
            if self.place.bees != []:
                ...
                random_bee(self.place.bees).reduce_health(b.health)
    ...
    def action(self, gamestate):
        ...
        while position:
            if position.ant is not None:
                ...
                if position.ant.is_container == True and position.ant.ant_contained is not None:
